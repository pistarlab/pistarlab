...
<div>
    ...
    <b-modal id="modal-configure-agent" title="Configure Agent" size="lg">
        <b-tabs content-class="mt-4" justified>
            ...
            <b-tab title="Environment Wrappers">
        ...
        <b-container fluid>
            ...
            <b-row>
                <b-col>
                    ...
                    <div v-else>
                        <b-card body-text-variant="" v-b-modal.modal-select-envspec class="h-100 card-shadow card-flyer" style="width: 100px;background-color:#ccc">
            ...
            <b-row>
                <b-col class="d-flex flex-wrap mb-4">
                    <span v-for="(agent,idx) in agents" v-bind:key="idx" class="mr-3">
                        <b-card no-body header-bg-variant="dark" header-text-variant="white" type="button" class="h-100 card-shadow card-flyer stretched-link" style="width: 320px" v-on:click="agentConfigModal(idx)">
                    ...
                    <span>
                        <b-card body-text-variant="" class="h-100 card-shadow card-flyer stretched-link" style="width: 100px;background-color:#ccc" v-b-modal.modal-select-agent>
                            <b-card-body class="text-center">

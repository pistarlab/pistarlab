<template>
  <div class="about">
    <h1>This is an about page <a class="btn btn-primary">test</a></h1>
        <b-card variant="dark" title="Powered by">
        <b-card-text>
            <b-link href="https://pytortch.org" style="color:black">
                <img height="50px" src="https://pytorch.org/assets/images/logo-icon.svg" alt="PyTorch" /> PyTorch
            </b-link>

            <b-link class="ml-3" href="https://ray.io">
                <img height="50px" src="https://raw.githubusercontent.com/ray-project/ray/master/doc/source/images/ray_header_logo.png" alt="Ray.io" />
            </b-link>

            <b-link class="ml-3" href="https://vuejs.org/" style="color:black">
                <img height="50px" src="https://vuejs.org/images/logo.png?_sw-precache=cf23526f451784ff137f161b8fe18d5a" alt="Vue.js" /> Vue.js
            </b-link>

            <b-link class="ml-3" href="https://vuejs.org/">
                <svg height="50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 936 232">
